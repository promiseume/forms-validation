...
export default function Form() {
  ...
  return (
    <div className="container">
       ...
       {Object.keys(error).length === 0 && isSubmit ? (<div className="success">Successful!!</div>):(<div className="invalid">Login</div>)}
          <h1>Login Form</h1>
          <div>
              <p>{error.email}</p>
        ...
        <p>{error.confirmPassword}</p>
            ...
            <input type="password" name="confirmPassword" placeholder="Confim Your Password" value={form.confirmPassword} onChange={handleChange} />
        </div>
